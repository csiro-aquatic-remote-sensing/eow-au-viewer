...
describe(`prepareTimeSeriesChartData`, () => {
  describe(`2 dates`, () => {
    it(`2 different dates, different fu, already sorted by date`, () => {
      const a = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 10}};
      const b = {values_: {date_photo: '2020-02-22T01:00:00', fu_value: 12}};
      const features = [a, b];
    ...
    it(`2 different dates, different fu, not sorted by date`, () => {
      const b = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 10}};
      const a = {values_: {date_photo: '2020-02-22T01:00:00', fu_value: 12}};
      const features = [a, b];
      const timeSeriesData = EowDataStruct.prepareTimeSeriesChartData(features);
    ...
    it(`2 dates same, different fu, sorted by fu`, () => {
      const a = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 10}};
      const b = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 12}};
      const features = [a, b];
      const timeSeriesData = EowDataStruct.prepareTimeSeriesChartData(features);
    ...
    it(`2 dates same, different fu, not sorted by fu`, () => {
      const b = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 10}};
      const a = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 12}};
      const features = [a, b];
      const timeSeriesData = EowDataStruct.prepareTimeSeriesChartData(features);
  ...
  describe(`3 dates`, () => {
    it(`3 different dates, different fu, already sorted by date`, () => {
      const a = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 10}};
      const b = {values_: {date_photo: '2020-02-22T01:00:00', fu_value: 12}};
      const c = {values_: {date_photo: '2020-02-23T01:00:00', fu_value: 14}};
    ...
    it(`3 different dates, different fu, not sorted by date`, () => {
      const c = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 10}};
      const b = {values_: {date_photo: '2020-02-22T01:00:00', fu_value: 12}};
      const a = {values_: {date_photo: '2020-02-23T01:00:00', fu_value: 14}};
      const features = [a, b, c];
      const timeSeriesData = EowDataStruct.prepareTimeSeriesChartData(features);
    ...
    it(`3 dates same, different fu, sorted by fu`, () => {
      const a = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 10}};
      const b = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 12}};
      const c = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 14}};
      const features = [a, b, c];
      const timeSeriesData = EowDataStruct.prepareTimeSeriesChartData(features);
    ...
    it(`3 dates same, different fu, not sorted by fu`, () => {
      const c = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 10}};
      const b = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 12}};
      const a = {values_: {date_photo: '2020-02-21T01:00:00', fu_value: 14}};
      const features = [a, b, c];
      const timeSeriesData = EowDataStruct.prepareTimeSeriesChartData(features);
